...
export class DomainTransactionFactoryV2 {
  ...
  protected setRoleDefinitionTx({
    ...
    const setRevokersTx = this.setRevokersTx({
      domain,
    ...
    const textProps = ((roleDef: IRoleDefinitionV2) => {
      return {
        ...
        requstorFields: roleDef.requestorFields,
  ...
  protected setRevokersTx({
    ...
    if (revokers.revokerType?.toUpperCase() === 'DID') {
      ...
      return {
        ...
        data: this._roleDefResolverInterface.encodeFunctionData(
          'setRevokerRole',
          [utils.namehash(domain), namehash(revokers.roleName)]
        ),
      };
    }
  ...
  protected setRevokerTypeTx({
    ...
    return {
      ...
      data: this._roleDefResolverInterface.encodeFunctionData(
        'setRevokerType',
        [utils.namehash(domain), revokerType]
      ),
    };
  }
